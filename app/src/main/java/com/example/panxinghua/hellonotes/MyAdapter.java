...
/**
 * Created by panxinghua on 16/5/11.
 * 因为图片和视频无法通过simpleadapter 添加，所以要自己创建一个新的adapter
 */
public class MyAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        timetv.setText(time);
        videoiv.setImageBitmap(getVideoThumbnail(urlvideo, 200, 200, MediaStore.Images.Thumbnails
                .MICRO_KIND));//getVideoThumbnail
        System.out.println(url);
        imgiv.setImageBitmap(getImageThumbnail(url,200,200));//getImageThumbnail
